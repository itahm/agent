...
public class Debugger extends Listener {
	...
	public Debugger(File f) throws Exception {
		super(2014);
		
		root = f;
		System.out.println(root.getAbsolutePath());
		System.out.println(String.format("ITAhM communicator started with TCP %d.", 2014));
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			final Debugger c = new Debugger(path);
